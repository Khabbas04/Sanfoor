                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
                    <div className="relative mb-20 text-center">
                        <div className={`inline-block px-12 py-8 rounded-[2.5rem] border transition-all duration-700 shadow-2xl relative overflow-hidden group ${isDark ? 'bg-slate-800/40 border-slate-700/50 shadow-indigo-500/10' : 'bg-white/80 border-slate-100 shadow-indigo-500/5'}`}>
                            ...
                            <h1 className={`text-4xl md:text-6xl font-black mb-3 relative z-10 ${isDark ? 'text-white' : 'text-slate-900'}`}>دليل المباني والكليات</h1>
                            <p className={`text-lg md:text-xl font-bold opacity-70 relative z-10 ${isDark ? 'text-slate-300' : 'text-slate-500'}`}>دليل مبسط للكليات ومعالم الجامعة</p>
