...
const translations = {
    ar: {
        ...
        simulatorRequests: 'طلبات المحاكي', nextSemesterForecast: 'توقعات الفصل القادم',
        ...
        student: 'طالب', noSimulatorData: 'لا يوجد بيانات محاكي مسجلة حالياً.',
    ...
    en: {
        ...
        simulatorRequests: 'Simulator Requests', nextSemesterForecast: 'Next Semester Forecast',
        ...
        student: 'students', noSimulatorData: 'No simulator data recorded yet.',
