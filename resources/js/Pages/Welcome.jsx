...
/* ─────────────────────────────────────────────
   Sanfoor – Premium Animated Landing Page
───────────────────────────────────────────── */
...
export default function Welcome({ auth }) {
    ...
    return (
        <MainLayout>
            ...
            <div className="bg-[#fafbff] text-slate-800 overflow-x-hidden font-t" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
                ...
                <section ref={heroRef} className="relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden pt-10 pb-36 sm:pb-44 hero-curve bg-transparent z-10 shadow-none">
                    ...
                    <div className="absolute inset-0 w-full h-[120%] -bottom-16 z-0 overflow-hidden rounded-b-[inherit]">
                        ...
                        <div className="absolute inset-0 bg-center opacity-10 pointer-events-none" style={{ backgroundImage: "url('/images/grid.svg')" }} />
                    ...
                    {/* Decorative Orbs */}
                    <div className="absolute hidden md:block w-[220px] h-[220px] bg-sky-500/20 blur-[100px] top-[10%] right-[10%] pointer-events-none z-0" />
                    <div className="absolute hidden md:block w-[200px] h-[200px] bg-blue-500/20 blur-[100px] bottom-[10%] left-[10%] pointer-events-none z-0" />

                    {/* Content */}
                    <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full mt-12">
                        ...
                        <div className="hero-animate mb-10 flex justify-center" style={{ animationDelay: '0.1s' }}>
                            <div className="relative inline-flex p-[1px] rounded-full overflow-hidden shadow-[0_0_35px_rgba(56,189,248,0.25)] group cursor-default select-none">
                                ...
                                <div className="inline-flex items-center gap-2.5 h-full w-full px-6 py-2.5 bg-[#0f172a]/95 rounded-full backdrop-blur-xl relative z-10">
                                    <Sparkles className="w-4 h-4 text-sky-400 animate-pulse" />
                                    <span className="font-bold text-[13px] tracking-wide text-transparent bg-clip-text bg-gradient-to-l from-sky-200 via-white to-white drop-shadow-sm">
                                        النظام الأكاديمي الذكي الأول
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="hero-animate relative inline-flex justify-center items-center mb-10 mt-2" style={{ animationDelay: '0.3s' }}>
                            ...
                            <div className="relative w-40 h-40 sm:w-52 sm:h-52 animate-float">
                        ...
                        <h1 className="hero-animate mb-8" style={{ animationDelay: '0.85s' }}>
                            <span className="block text-4xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-black leading-[1.1] tracking-tight text-transparent bg-clip-text bg-gradient-to-l from-cyan-300 to-blue-300 drop-shadow-[0_10px_25px_rgba(0,0,0,0.95)]">
                                التفوق الأكاديمي.
                            </span>
                        </h1>
                        ...
                        <div className="h-rise-slow" style={{ animationDelay: '1.1s' }}>
                            <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-slate-300 mb-8 font-medium leading-relaxed px-4">
                                <strong className="text-white font-bold">سنفور</strong> ليس مجرد موقع، إنه مستشارك الشخصي. يرسم لك خريطة تخصصك، يفتح لك المواد المتاحة، ويخطط فصلك القادم بدقة مع <span className="text-cyan-300 font-bold">AI Sanfoor</span>.
                            </p>
                        </div>
                        ...
                        <div className="h-rise-slow flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-5" style={{ animationDelay: '1.35s' }}>
                            {auth.user ? (
                                <MagneticButton>
                                    <Link id="tour-cta-btn" href={route('tree.index')} className="btn-shimmer flex items-center justify-center gap-3 px-10 py-[1.15rem] sm:py-5 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white text-base sm:text-lg font-bold rounded-2xl transition-all shadow-xl shadow-blue-500/30 active:scale-[0.96] w-full sm:w-auto">
                                ...
                                <>
                                    <MagneticButton>
                                        <Link href={route('login')} className="btn-shimmer flex items-center justify-center gap-3 px-10 py-[1.15rem] sm:py-5 bg-white text-slate-900 text-base sm:text-lg font-black rounded-2xl hover:bg-slate-50 transition-all shadow-2xl shadow-white/10 active:scale-[0.96] w-full sm:w-auto">
                                            <span>ابدأ رحلتك الآن</span>
                                            <ArrowLeft className="w-5 h-5 group-hover:-translate-x-1.5 transition-transform duration-300" />
                                        </Link>
                                    </MagneticButton>
                                    <MagneticButton>
                                        <a href="#features" className="flex items-center justify-center gap-2 px-8 py-[1.15rem] sm:py-5 bg-white/5 backdrop-blur-md text-white text-base sm:text-lg font-bold rounded-2xl hover:bg-white/10 border border-white/10 transition-all w-full sm:w-auto">
                                            <span>شوف كيف بيشتغل</span>
                                            <ChevronLeft className="w-5 h-5 -rotate-90 animate-bounce" />
                                        </a>
                                    </MagneticButton>
                                </>
                            )}
                ...
                <section id="features" ref={featRef} className="py-20 sm:py-32 bg-white relative overflow-hidden -mt-10 pt-32">
                    <div className="absolute top-20 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none z-20 overflow-hidden">
                        <span className="text-[6rem] sm:text-[12rem] md:text-[16rem] font-black text-slate-900/[0.02] whitespace-nowrap tracking-tighter">FEATURES</span>
                    </div>
                    <div className="absolute inset-0 bg-center opacity-[0.03] pointer-events-none z-0" style={{ backgroundImage: "url('/images/grid.svg')" }} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: 'شروحات مركزة لكل فصل مع أمثلة وتمارين تساعدك تراجع وتثبت المعلومة بسرعة وبدون تشتت.',
                                ...
                                },
                                {
                                    icon: ShieldCheck,
                                    title: 'بنك الأسئلة',
                                    desc: 'تجميعة أسئلة مختارة وتمارين متدرجة عشان تختبر نفسك قبل الامتحان بثقة وتتأكد من فهمك.',
                                ...
                                },
                                {
                                    icon: Map,
                                    title: 'دليل الكليات',
                                    desc: 'اعرف مباني الكليات ومواقعها والخدمات القريبة منها عبر دليل واضح وسهل التصفح للمستجدين.',
                                ...
                                <div
                                    key={i}
                                    id={`tour-feature-${i + 1}`}
                                    className={`card-lift group p-8 sm:p-10 rounded-3xl bg-white border border-slate-200/80 relative overflow-hidden transition-all duration-[0.9s] ease-[cubic-bezier(0.16,1,0.3,1)] hover:shadow-xl ${featIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
                                ...
                                >
                                    ...
                                    <div className={`relative z-10 w-14 h-14 rounded-2xl bg-gradient-to-tr ${f.gradient} flex items-center justify-center mb-6 shadow-lg ${f.shadowColor} group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 text-white`}>
                                        <f.icon className="w-7 h-7" />
                                    </div>

                                    <h3 className="relative z-10 text-xl font-black text-slate-900 mb-3 leading-snug">{f.title}</h3>
                                    <p className="relative z-10 text-slate-500 font-medium leading-[1.8] text-[14px] sm:text-[15px]">{f.desc}</p>

                                    <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${f.gradient} scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-right`} />
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                ════════════════════════════════════ */}
                <section ref={previewRef} className="py-20 sm:py-32 relative overflow-hidden bg-[#0f172a] border-t border-slate-800">
                    <div className="absolute top-20 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none z-20 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-center opacity-5 pointer-events-none z-0" style={{ backgroundImage: "url('/images/grid.svg')" }} />
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className={`text-center mb-12 sm:mb-16 transition-all duration-[1.1s] ease-[cubic-bezier(0.16,1,0.3,1)] ${previewIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-14'}`}>
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 text-cyan-300 text-xs font-bold mb-6 border border-white/10 backdrop-blur-sm">
                        ...
                        <div className={`max-w-3xl mx-auto transition-all duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] ${previewIn ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`} style={{ transitionDelay: '200ms' }}>
                            <div className="relative bg-[#1e293b]/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-6 sm:p-10 overflow-hidden shadow-2xl">
                                <div className="absolute -inset-[1px] rounded-3xl overflow-hidden pointer-events-none">
                                    <div className="absolute inset-[-50%] bg-[conic-gradient(from_0deg,transparent_0%,#3b82f640_25%,transparent_50%)]" style={{ animation: 'rotate-border 8s linear infinite' }} />
                                </div>
                                ...
                                <svg viewBox="0 0 500 280" className="w-full h-auto relative z-10" dir="ltr">
                                    {previewIn && <>
                                        ...
                                        <TreeNode x="284" y="95" delay={0.9} color="#0ea5e9" label="متاحة" />
                                        <TreeNode x="404" y="95" delay={1.0} color="#0ea5e9" label="متاحة" />

                                        <TreeNode x="14" y="185" delay={1.2} color="#0ea5e9" label="متاحة" />
                ...
                <section ref={aiRef} className="py-24 sm:py-32 bg-slate-50 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-center opacity-40 pointer-events-none z-0" style={{ backgroundImage: "url('/images/grid.svg')" }} />
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
                            ...
                            <div className={`transition-all duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] ${aiIn ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-14'}`}>
                                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-100 text-indigo-700 border border-indigo-200 mb-6 font-bold text-xs">
                                ...
                                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight leading-[1.2]">
                                    محتار شو تنزل؟ <br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-blue-500">اسأل مستشارك الذكي.</span>
                                </h2>
                                <p className="text-slate-500 font-medium text-base sm:text-lg leading-relaxed mb-8 max-w-lg">
                                    دربنا نموذج ذكاء اصطناعي خصيصاً ليقرأ خطتك الجامعية، يفهم القوانين، ويقترح عليك أفضل خيارات التسجيل اللي بترفع معدلك وبتقربك من التخرج بضغطة زر.
                                </p>
                            ...
                            <div className={`relative transition-all duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] delay-200 ${aiIn ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-14'}`}>
                                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-blue-500/20 rounded-[2.5rem] blur-3xl transform rotate-3"></div>
                                <div className="relative bg-white/80 backdrop-blur-xl border border-white/50 rounded-[2.5rem] shadow-2xl p-6 sm:p-8 flex flex-col gap-6" dir="rtl">

                                    {/* Student Message */}
                                    {aiIn && (
                                        <div className="chat-msg-1 self-end bg-gradient-to-l from-indigo-600 to-blue-600 text-white p-4 px-5 rounded-3xl rounded-tr-sm max-w-[85%] shadow-md">
                                    ...
                                    {/* AI Message */}
                                    {aiIn && (
                                        <div className="chat-msg-2 self-start bg-slate-50 border border-slate-200 text-slate-800 p-5 rounded-3xl rounded-tl-sm max-w-[90%] shadow-sm relative">
                                            <div className="absolute -top-4 -left-4 w-9 h-9 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl flex items-center justify-center text-white shadow-lg border-2 border-white rotate-3">
                                                <Bot className="w-5 h-5" />
                                            </div>
                                            <p className="text-[14px] font-medium leading-loose mt-1">
                                                أهلاً بك! بناءً على خطتك، أنصحك بتنزيل:
                                                <br />
                                                <strong className="text-blue-600 font-bold">1. برمجة متقدمة (3س):</strong> ضرورية لأنها تفتح 3 مواد للفصل القادم.
                                                <br />
                                                <strong className="text-emerald-600 font-bold">2. مهارات حياتية (3س):</strong> متطلب جامعة سهل يساعد برفع المعدل بشكل كبير.
                                            </p>
                                        </div>
                                    )}
                                    ...
                                    {/* Typing Indicator */}
                                    {aiIn && (
                                        <div className="self-start bg-slate-100 rounded-full px-5 py-3 flex items-center gap-1.5 opacity-0 border border-slate-200 shadow-sm" style={{ animation: 'chat-pop 0.6s ease forwards', animationDelay: '2.5s' }}>
                ...
                <section ref={howRef} className="py-20 sm:py-32 bg-white relative overflow-hidden">
                    <div className="absolute top-20 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none z-20 overflow-hidden">
                        <span className="text-[6rem] sm:text-[12rem] md:text-[16rem] font-black text-slate-900/[0.02] whitespace-nowrap tracking-tighter">WORKFLOW</span>
                    </div>
                    <div className="absolute inset-0 bg-center opacity-[0.03] pointer-events-none z-0" style={{ backgroundImage: "url('/images/grid.svg')" }} />
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        ...
                        <div className={`text-center mb-16 sm:mb-20 transition-all duration-[1.1s] ease-[cubic-bezier(0.16,1,0.3,1)] ${howIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-14'}`}>
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-50 text-cyan-700 text-xs font-bold mb-6 border border-cyan-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14 relative">
                            ...
                            {[
                                { step: '01', title: 'اختار تخصصك', desc: 'حدد تخصصك، وسنفور بيجهز لك المواد والمتطلبات تلقائياً بثوانٍ بدون جهد.', gradient: 'from-sky-400 to-blue-500', glow: 'shadow-blue-500/20' },
                                { step: '02', title: 'حدد المواد المنجزة', desc: 'علّم على المواد اللي نجحت فيها. الشجرة بتتحدث فوراً وبتفتحلك المتاح بشكل ذكي.', gradient: 'from-cyan-400 to-cyan-600', glow: 'shadow-cyan-500/20' },
                                { step: '03', title: 'خطط فصلك بذكاء', desc: 'استخدم التسجيل التجريبي أو اسأل المرشد الآلي لترتيب جدولك صح من أول مرة.', gradient: 'from-indigo-400 to-indigo-600', glow: 'shadow-indigo-500/20' },
                            ].map((s, i) => (
                                <div
                                    key={i}
                                ...
                                >
                                    <div className={`mx-auto md:mx-0 w-16 h-16 rounded-2xl bg-gradient-to-br ${s.gradient} flex items-center justify-center text-white text-xl font-black mb-6 shadow-lg ${s.glow} hover:scale-110 hover:-rotate-3 transition-all duration-500 cursor-default`}>
                                        {s.step}
                                    </div>
                                    <h3 className="text-xl font-black text-slate-900 mb-3">{s.title}</h3>
                                    <p className="text-slate-500 font-medium leading-[1.8] text-[14px] sm:text-[15px]">{s.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                ════════════════════════════════════ */}
                {!auth.user && (
                    <section ref={ctaRef} className="py-20 sm:py-28 relative overflow-hidden bg-[#0f172a] border-t border-slate-800">
                        <div className="absolute inset-0 bg-center opacity-10 pointer-events-none" style={{ backgroundImage: "url('/images/grid.svg')" }} />
                        <div className="absolute w-[400px] h-[400px] bg-sky-500/10 blur-[100px] top-[-20%] right-[-10%] pointer-events-none" />
                        <div className="absolute w-[300px] h-[300px] bg-indigo-500/10 blur-[100px] bottom-[-20%] left-[-8%] pointer-events-none" />

                        <div className={`max-w-4xl mx-auto px-4 relative z-10 text-center transition-all duration-[1.2s] ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col items-center ${ctaIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-14'}`}>
                            
                            <div className="inline-flex items-center justify-center w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-white/5 border border-white/10 mb-8 backdrop-blur-md shadow-2xl p-4" style={{ animation: 'bounce-s 3s ease-in-out infinite' }}>
                                <img src="/images/sanfoor.png" alt="Sanfoor Logo" className="w-full h-full object-contain drop-shadow-[0_8px_16px_rgba(0,0,0,0.6)]" />
                            </div>

                            <h2 className="text-3xl sm:text-4xl md:text-[3.25rem] font-black text-white mb-5 leading-tight tracking-tight">
                                جاهز تبدأ مشوارك <br className="hidden sm:block" />بأذكى طريقة؟
                            </h2>
                            <p className="text-slate-300 font-medium text-base sm:text-lg mb-10 max-w-xl mx-auto leading-relaxed">
                                انضم للطلاب اللي حولوا خطتهم لنجاح حقيقي. سجّل حسابك الآن وابدأ التخطيط لفصلك القادم بضغطة زر.
                            </p>
                            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full sm:w-auto">
                                <MagneticButton>
                                    <a href={route('auth.microsoft.redirect')} className="shimmer flex items-center justify-center gap-3 px-10 py-[1.15rem] sm:py-5 bg-white text-slate-900 text-base sm:text-lg font-black rounded-2xl hover:bg-slate-100 transition-all shadow-2xl shadow-black/40 active:scale-[0.96] w-full sm:w-auto">
                                        تسجيل الدخول الجامعي
                                    </a>
                                </MagneticButton>
                                <MagneticButton>
