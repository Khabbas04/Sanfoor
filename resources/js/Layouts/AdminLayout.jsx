...
export default function AdminLayout({ children }) {
    ...
    const translations = {
        ar: {
            ...
            logs: 'سجل العمليات',
            studentLogs: 'نشاط الطلاب',
            students: 'إدارة الطلاب',
            instructors: 'الكادر التدريسي',
            admins: 'إدارة الأدمنز',
            scheduleReviews: 'مراجعة الخطط',
            settings: 'الإعدادات',
            ...
            pageTitles: {
                ...
                'admin.sections.index': 'إدارة الشُعب والمواعيد',
                ...
                'student-logs': 'سجل نشاط الطلاب',
                'admin.students.index': 'إدارة الطلاب',
                'admin.instructors.index': 'إدارة الكادر التدريسي',
                ...
                'schedule_reviews.show': 'تقييم الخطة',
        ...
        en: {
            ...
            logs: 'Activity Log',
            studentLogs: 'Student Activity',
            students: 'Manage Students',
            instructors: 'Manage Instructors',
            admins: 'Manage Admins',
            scheduleReviews: 'Plan Reviews',
            settings: 'Settings',
            mainMenu: 'Main Menu',
            online: 'Online',
            ...
            pageTitles: {
                ...
                'admin.sections.index': 'Course Sections',
                ...
                'admin.student-logs': 'Student Activity Log',
                ...
                'schedule_reviews.show': 'Review Plan',
    ...
    const safeRoute = (name, params) => {
        try {
            ...
            const map = {
                ...
                'admin.student-logs': '/admin/student-logs',
                'admin.instructors.index': '/admin/instructors',
                'admin.logs': '/admin/logs',
                'admin.settings': '/admin/settings',
                'admin.ai_chats': '/admin/ai-chats',
                'admin.ai_monitor': '/admin/ai-monitor',
                'schedule_reviews.index': '/schedule-reviews',
                'admin.site_feedbacks.index': '/admin/site-feedbacks',
            };
            return map[name] || '#';
        }
    };
    ...
    const menuSections = [
        ...
        },
        {
            ...
            items: [
                ...
                { icon: '🗓️', name: t.sections, route: 'admin.sections.index', pattern: 'admin.sections.*' },
        ...
        },
        {
            ...
            items: [
                ...
                { icon: '🌟', name: lang === 'ar' ? 'آراء وتجارب المنصة' : 'Site Feedbacks', route: 'admin.site_feedbacks.index', pattern: 'admin.site_feedbacks.*' },
