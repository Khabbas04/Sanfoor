                    ...
                    <nav className={`nav-capsule pointer-events-auto w-full max-w-[1400px] top-0 h-[90px] sm:h-[120px] bg-transparent border-b border-transparent ${scrolled ? 'nav-scrolled' : ''}`}>
                        <div className="h-full px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3">
                                <button onClick={toggleLang} className={`w-10 h-10 rounded-xl flex items-center justify-center text-[10px] font-black border transition-all active:scale-90 pointer-events-auto ${isDark ? 'bg-slate-800 border-white/10 text-indigo-400 hover:bg-slate-700' : 'bg-white border-slate-200 text-indigo-600 shadow-sm hover:bg-slate-50'}`}>
                                    {lang === 'ar' ? 'EN' : 'AR'}
                                </button>
                                <button onClick={toggleTheme} className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg transition-all active:scale-90 pointer-events-auto ${isDark ? 'bg-slate-800 text-yellow-400 border border-white/10 hover:bg-slate-700' : 'bg-white text-slate-400 border border-slate-200 shadow-sm hover:bg-slate-50'}`}>
                                    {isDark ? '☀️' : '🌙'}
                                </button>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10 relative z-10">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-b border-white/10 pb-16">
                            ...
                            <div className="md:col-span-3 space-y-5">
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li><Link href={route('campus.directory')} className="text-slate-400 hover:text-indigo-400 transition-all text-sm font-bold">🏢 {t.directory}</Link></li>
                        ...
                        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                            <p className="text-slate-500 text-[11px] font-bold">
                                &copy; {new Date().getFullYear()} {lang === 'ar' ? 'سنفور' : 'Sanfoor'}. Developed by Kulliya Team.
                            </p>
                        </div>
                    </div>
                </footer>
