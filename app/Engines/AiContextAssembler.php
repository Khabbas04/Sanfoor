...
class AiContextAssembler
{
    ...
    public function build(array $rules, array $rankedCourses, array $ragData, array $documentContext, array $riskWarnings = []): array
    {
        ...
        $systemPrompt .= "🔴 تنبيه هام جداً 🔴: إذا طلب الطالب رؤية (خطته الشجرية، خريطة المواد، الشجرة)، إياك أن تعتذر أو تقول أنك لا تستطيع الرسم! فقط أضف هذا النص الحرفي في ردك وسيقوم النظام الداخلي برسمها فوراً: %%SKILL_TREE%%\n\n";
