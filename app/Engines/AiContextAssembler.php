...
class AiContextAssembler
{
    ...
    public function build(array $rules, array $rankedCourses, array $ragData, array $documentContext): array
    {
        ...
        $systemPrompt .= "2. إذا طلب اقتراح مواد، اقترح فقط من 'المواد المقترحة' باستخدام الـ ID.\n";
        $systemPrompt .= "3. إذا تجاوز الحد المسموح، اقترح إزالة مواد باستخدام الـ ID من مواد السلة.\n";
        $systemPrompt .= "4. لا تقم بحساب عدد الغيابات رياضياً (مثل تحويل 15% إلى ساعات)، اذكر النسبة كما هي في القوانين لتجنب الخطأ.\n";
        $systemPrompt .= "5. التزم دائماً بصيغة JSON المحددة أدناه ولا تضف أي نص خارج الـ JSON.\n\n";
