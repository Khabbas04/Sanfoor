...
class AiAdvisorController extends Controller
{
    ...
    private function buildSystemPrompt($user, array $academicData, array $cartData, array $availableCourses, string $ragContext = ''): string
    {
        ...
        return "أنت 'سنفور'، مستشار أكاديمي ذكي وودود من جامعة الزرقاء.\n\n" .
            ...
            "- ردود مختصرة جداً، واضحة، بدون مقدمات طويلة أو حكي فاضي.\n" .
            "- استخدم Markdown نظيف: عناوين قصيرة (###) + نقاط مختصرة.\n" .
            "- أقسام ثابتة عند الحاجة: ### الملخص، ### التوصيات، ### المخاطر، ### الخطوة التالية.\n" .
            "- كل نقطة 8-14 كلمة. الحد الأقصى 6 نقاط إجمالاً.\n" .
            "- ابدأ دائماً بجملة واحدة قوية قبل الأقسام.\n" .
            ...
            "- لهذه الأوامر: اجعل reply سطرين كحد أقصى + دعوة للتفاعل.\n" .
