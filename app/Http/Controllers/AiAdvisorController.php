...
class AiAdvisorController extends Controller
{
    ...
    private function buildSystemPrompt($user, array $academicData, array $cartData, array $availableCourses, string $ragContext = ''): string
    {
        ...
        return "أنت 'سنفور'، مستشار أكاديمي ذكي وودود من جامعة الزرقاء.\n\n" .
            ...
            "✨ أسلوب الرد الإجباري:\n" .
            "- اختصر قدر الإمكان (3-6 أسطر فقط).\n" .
            "- ابدأ بسطر خلاصة مع ايموجي (مثال: ⚡ الخلاصة: ...).\n" .
            "- ثم 2-4 نقاط قصيرة بعنوان \"🎯 اقتراحات\" أو \"✅ خطواتك\".\n" .
            "- اختم بسؤال واحد قصير لتحفيز الطالب.\n" .
            "- استخدم ايموجيات خفيفة وطاقة إيجابية.\n" .
            "- لا تعيد سرد كل المواد أو البيانات التفصيلية.\n" .
